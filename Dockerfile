...
RUN env DEBIAN_FRONTEND=noninteractive && apt update && apt install wget tar xz-utils -y && \
...
RUN env DEBIAN_FRONTEND=noninteractive && apt update && apt install libc6-amd64-cross qemu-user -y && \
